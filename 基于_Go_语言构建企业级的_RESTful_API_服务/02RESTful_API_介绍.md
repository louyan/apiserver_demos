...
REST 代表表现层状态转移（REpresentational State Transfer），由 Roy Fielding 在他的 [论文](https://link.juejin.im?target=https%3A%2F%2Fwww.ics.uci.edu%2F~fielding%2Fpubs%2Fdissertation%2Ftop.htm) 中提出。REST 是一种软件架构风格，不是技术框架，REST 有一系列规范，满足这些规范的 API 均可称为 RESTful API。REST 规范中有如下几个核心：
...
RPC 的调用过程如下（图片来自 [How RPC Works](https://link.juejin.im?target=https%3A%2F%2Fdocs.microsoft.com%2Fen-us%2Fprevious-versions%2Fwindows%2Fit-pro%2Fwindows-server-2003%2Fcc738291(v%3Dws.10))）：
![网图](https://user-gold-cdn.xitu.io/2018/6/17/1640cdbb95ac1a37?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
