...
![](https://user-gold-cdn.xitu.io/2018/6/24/164312436d105b7b?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
编译并运行 `apiserver`
...
**QPS & 平均响应时间:**
![](https://user-gold-cdn.xitu.io/2018/6/24/164326289814ddd1?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
**成功率**
![](https://user-gold-cdn.xitu.io/2018/6/24/1643263075791269?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
**QPS & 平均响应时间对比**
![](https://user-gold-cdn.xitu.io/2018/6/24/164326abb2c45da8?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
**成功率对比**
![](https://user-gold-cdn.xitu.io/2018/6/24/164326adde2e5c40?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
在 [go tool pprof](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fhyper0x%2Fgo_command_tutorial%2Fblob%2Fmaster%2F0.12.md) 文章中，我们知道，在默认情况下，top 命令输出的列表中只包含本地取样计数最大的前十个函数，统计的是这些函数本身运行的执行时间，实际上我们还需要知道，函数中有没有调用耗时的函数以及执行其它函数所耗费的时间，这种情况下我们需要按累积取样计数来排序，这在 pprof 中需要加上 `-cum` 参数：
...
![](https://user-gold-cdn.xitu.io/2018/6/25/164328b7f9edba30?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
1. middleware.NoCache 和 middleware.Options（router/router.go 文件中）

![](https://user-gold-cdn.xitu.io/2018/6/25/164328ba8751e252?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
删除无用的 Gin middleware 重新编译 apiserver，启动 apiserver，测试性能后，再跟原生的 HTTP Server 对比，结果如下。

**QPS & 平均响应时间对比**
![](https://user-gold-cdn.xitu.io/2018/6/24/164327a1d8bfeb4d?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
**成功率对比**
![](https://user-gold-cdn.xitu.io/2018/6/24/164327a4a217a566?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
