...
> 本小节源码下载路径：[demo15](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Ftree%2Fmaster%2Fdemo15)
> 
> 可先下载源码到本地，结合源码理解后续内容，边学边练。
> 
> 本小节的代码是基于 [demo14](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Ftree%2Fmaster%2Fdemo14) 来开发的。
...
在 `util/util_test.go` 测试文件中，新增两个性能测试函数：`BenchmarkGenShortId()` 和 `BenchmarkGenShortIdTimeConsuming()`（详见 [demo15/util/util_test.go](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Fblob%2Fmaster%2Fdemo15%2Futil%2Futil_test.go)）：
...
funcBenchmarkGenShortIdTimeConsuming(b *testing.B) {
	...
	b.StartTimer() // 重新开始时间for i := 0; i < b.N; i++ {
		GenShortId()
	}
}
...
![](https://user-gold-cdn.xitu.io/2018/6/5/163d01d751cb3087?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
该调用图生成方法如下：
...
> 关于如何看懂 pprof 信息，请参考官方文档 [Profiling Go Programs](https://link.juejin.im?target=https%3A%2F%2Fblog.golang.org%2Fprofiling-go-programs)。
> 
> 关于如何做性能分析，请参考郝林大神的文章 [go tool pprof](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fhyper0x%2Fgo_command_tutorial%2Fblob%2Fmaster%2F0.12.md)。
...
至于怎么去分析性能，比如查找耗时最久的函数等，笔者链接了郝林大神专业的分析方法（[go tool pprof](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fhyper0x%2Fgo_command_tutorial%2Fblob%2Fmaster%2F0.12.md)），更深的分析技巧需要读者在实际开发中自己去探索。