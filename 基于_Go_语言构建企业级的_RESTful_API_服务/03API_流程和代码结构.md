...
## HTTP API 服务器启动流程
![](https://user-gold-cdn.xitu.io/2018/5/30/163acb3ab9fd10ff?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
## HTTP 请求处理流程
![网图](https://user-gold-cdn.xitu.io/2018/5/30/163adeb520ed5673?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
一次完整的 HTTP 请求处理流程如上图所示。（图片出自[《HTTP 权威指南》](https://link.juejin.im?target=https%3A%2F%2Fbook.douban.com%2Fsubject%2F10746113%2F)，推荐想全面理解 HTTP 的读者阅读此书。）

**1. 建立连接**

客户端发送 HTTP 请求后，服务器会根据域名进行域名解析，就是将网站名称转变成 IP 地址：localhost -> 127.0.0.1，Linux hosts文件、DNS 域名解析等可以实现这种功能。之后通过发起 TCP 的三次握手建立连接。TCP 三次连接请参考 [TCP 三次握手详解及释放连接过程](https://link.juejin.im?target=https%3A%2F%2Fblog.csdn.net%2Foney139%2Farticle%2Fdetails%2F8103223)，建立连接之后就可以发送 HTTP 请求了。
...
![](https://user-gold-cdn.xitu.io/2018/6/27/1643f2e4e3da9dcd?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
