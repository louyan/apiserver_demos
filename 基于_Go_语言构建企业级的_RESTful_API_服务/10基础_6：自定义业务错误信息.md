...
> 本小节源码下载路径：[demo05](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Ftree%2Fmaster%2Fdemo05)
> 
> 可先下载源码到本地，结合源码理解后续内容，边学边练。
> 
> 本小节的代码是基于 [demo04](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Ftree%2Fmaster%2Fdemo04) 来开发的。
...
我们通过一个新包 `errno` 来做错误码的定制，详见 [demo05/pkg/errno](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Ftree%2Fmaster%2Fdemo05%2Fpkg%2Ferrno)。
...
目前错误码没有一个统一的设计标准，笔者研究了 BAT 和新浪开放平台对外公布的错误码设计，参考新浪开放平台 [Error code](https://link.juejin.im?target=http%3A%2F%2Fopen.weibo.com%2Fwiki%2FError_code) 的设计，如下是设计说明：
...
错误代码说明：
![](https://user-gold-cdn.xitu.io/2018/6/1/163b938084a7e9e9?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
1. `router/router.go` 中添加路由，详见 [demo05/router/router.go](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Fblob%2Fmaster%2Fdemo05%2Frouter%2Frouter.go)：

![](https://user-gold-cdn.xitu.io/2018/6/1/163b9570311afe43?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
1. `handler` 目录下增加业务处理函数 `handler/user/create.go`，详见 [demo05/handler/user/create.go](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Flexkong%2Fapiserver_demos%2Fblob%2Fmaster%2Fdemo05%2Fhandler%2Fuser%2Fcreate.go)。
...
1. 将 `apiserver_demos/demo05` 复制为 `$GOPATH/src/apiserver`
...
![](https://user-gold-cdn.xitu.io/2018/6/1/163b9c03a0a6033e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
